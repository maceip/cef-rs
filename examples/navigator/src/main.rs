//! Headless / windowed CEF off-screen rendering host for automated web agents.
//!
//! Long-term goal: CLI and programmatic API compatibility with
//! [agent-browser](https://github.com/vercel-labs/agent-browser/blob/main/README.md#L92)
//! (`open`, `snapshot`, `click`, `fill`, etc.), using the maceip/cef journal-branch
//! build and agent-specific C APIs as they land in this workspace.
...
use crate::webrender::{
    ClientBuilder, NavigatorApp, NavigatorRenderHandler, NavigatorRequestContextHandler,
...
impl ApplicationHandler for App {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        let (render_handler, browser_size) = NavigatorRenderHandler::new(
        ...
        let mut context = cef::request_context_create_context(
            ...
            Some(&mut RequestContextHandlerBuilder::build(
                NavigatorRequestContextHandler {},
            )),
        );
        ...
        self.browser.replace(BrowserHost {
...
fn main() -> std::process::ExitCode {
    ...
    let mut app = webrender::AppBuilder::build(NavigatorApp::new());
